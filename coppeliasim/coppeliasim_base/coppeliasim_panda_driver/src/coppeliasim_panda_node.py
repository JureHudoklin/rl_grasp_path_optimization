...
class CoppeliaSimManipulatorDriver(object):
    ...
    def __init__(self, client, client_ID, joint_names):
        ...
        self.obj_handles = {
            name:
            self.client.simxGetObjectHandle(name,self.client.simxServiceCall())[1]
        ...
        # instance variables for manipulator
        ...
        for name in joint_names:
            self.client.simxGetJointPosition(
                ...
                self.client.simxDefaultSubscriber(GetJointPositionCallback(self.joint_position, name)))
