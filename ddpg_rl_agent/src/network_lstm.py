...
class ActorNetwork():
    ...
    def get_actor(self):
        ...
        inputs = layers.Input(shape=(2, self.num_states))
        out = layers.SimpleRNN(64)(inputs)
...
class CriticNetwork():
    ...
    def get_critic(self):
        # State as input
        state_input = layers.Input(shape=(2, self.num_states))
        state_out = layers.SimpleRNN(64)(state_input)
